...
export const config = {
  ...
  cloudbedsDailyCallBudget: optionalNumber("CLOUDBEDS_DAILY_CALL_BUDGET", 500),
  airdnaApiKey: optionalString("AIRDNA_API_KEY"),
  airdnaBaseUrl: process.env.AIRDNA_BASE_URL ?? "https://api.airdna.co",
  airdnaDailyCallBudget: optionalNumber("AIRDNA_DAILY_CALL_BUDGET", 200),
